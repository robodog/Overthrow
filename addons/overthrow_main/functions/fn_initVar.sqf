...
}foreach("(getNumber (_x >> 'scope') isEqualTo 2) && (configName _x isKindOf 'House') &&  ( (configName _x find '_House' > -1) ||(configName _x find '_HouseV' > -1) ||(configName _x find  'Panelak' > -1) || (configName _x find 'Villa' >-1) || (configName _x find 'Hotel' >-1) ) " configClasses (configfile >> "CfgVehicles"));
